...
start_game_gateway() ->
  ...
  GatewayListenAddress = config_server:get(game_gateway_config_server,game_gateway_listen_address),
  ...
  ok = global:sync(),
  RegisterInfo = {register_a_gateway_node,erlang:node(),{GatewayListenAddress, GatewayListenPort}},
